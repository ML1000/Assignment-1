...
shinyServer(
  ...
  ############################################################################################################
  ## This the version to work with the shiny app
  ###########################################################################################
  ...
  dia  <- input$mes, ##1,
  mes1 <- input$day, ##,
  data1[10]    <-  input$precip,
  data1[11]    <-  input$tempmax, ##30,
  data1[12]    <-  input$tempmin, ##15,
  data1[13]    <-  input$tempmed, ##20,
  data1[14]    <-  input$humid, ##70,
  data1[15]    <-  input$sun, ##2.4,
  ##  print(register)
  print(dia),
  print(mes1),
